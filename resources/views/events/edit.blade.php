                        ...
                        <div class="form-group">
                            ...
                            <div class="checkbox-group">
                                ...
                                <div class="checkbox-item">
                                  ...
                                  <div class="checkbox-item">
                                    <input type="checkbox" name="surete" id="surete" {{ $event->attachments ? 'checked' : '' }}>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($actions as $index => $action)
                                            <tr class="action-row">
                                                ...
                                                <td><input type="text" name="actions[{{ $index }}][responsable]" class="form-control" required value="{{ $action['responsable'] }}"></td>
                                                <td><input type="date" name="actions[{{ $index }}][delai]" class="form-control" id="deadline{{ $index }}" required value="{{ $action['delai'] }}"></td>
                                                <td>
