    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-4 py-4">
                ...
                <a href="{{ route('checklist.create') }}" class="btn btn-primary inline-flex items-center px-4 py-2 mb-4 text-xs font-semibold uppercase bg-green-600 text-white rounded-md hover:bg-green-500" style="float: right">
                    {{ __('Create CheckList') }}
                </a>
                <div class="card-body">
...
<script src="https://cdn.datatables.net/2.3.1/js/dataTables.min.js"></script>
    ...
    $(document).ready(function () {
        ...
        $('body').on('click', '.delete-cheklist', function () {
            deleteChecklist($(this));
        });
        function deleteChecklist(data) {
            let active = "Delete";
                let remove_name = data.data("name");
            ...
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        ...
                        data: { '_method': 'DELETE' },
                        url: "checklist/destory/" + remove_name,
                        type: 'Post',
