                ...
                <form action="{{ route('category.update', $category->id) }}" method="POST">
                    ...
                    <div class="mb-4">
                        <label for="category_description"
                            class="block mb-2 text-sm font-bold text-gray-700">{{ __('Talk/Animation Description') }}</label>
                        <textarea class="form-control" cols="40" rows="7" name="description"
                            placeholder="{{ __('Enter Talk/Animation description') }}">{{ old('description', $category->description) }}</textarea>
                    </div>
                    <div>
