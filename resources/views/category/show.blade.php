          ...
          <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-4 py-4">
              ...
              <div class="mb-4">
                  <label for="category_name"
                      class="block mb-2 text-sm font-bold text-gray-700"><b>{{ __('Talk/Animation name') }} : </b><span>{{ $category->name }}</span> </label> 
              </div>
              <div class="mb-4">
                  <label for="category_description"
                      class="block mb-2 text-sm font-bold text-gray-700"><b>{{ __('Talk/Animation Description') }} : </b><span>{{ $category->description }}</span> </label>
