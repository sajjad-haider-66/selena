        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-4 py-4">
                ...
                <form action="{{ route('subcategory.update', $subcategory->id) }}" method="POST">
                    ...
                    <div class="mb-4">
                        <label for="name"
                            class="block mb-2 text-sm font-bold text-gray-700">{{ __('Daily Work Readiness Name') }} <span
                                class="text-red-600">*</span></label>
                        <input type="text" name="name" class="form-control"
                            placeholder="{{ __('Enter Daily Work Readiness name') }}" maxlength="100"
                    ...
                    <div class="mb-4">
                        <label for="description"
                            class="block mb-2 text-sm font-bold text-gray-700">{{ __('Daily Work Readiness Description') }}
                        </label>
