            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-4 py-4">
                ...
                <div class="mb-4">
                    <label for="category_name"
                        class="block mb-2 text-sm text-gray-700"><b>{{ __('Daily Work Readiness name') }} : </b> <span>{{ $subcategory->name }}</span> </label>
                </div>
                <div class="mb-4">
                    <label for="category_description"
                        class="block mb-2 text-sm font-bold text-gray-700"><b>{{ __('Daily Work Readiness description') }} : </b><span>{{ $subcategory->description }}</span></label>
