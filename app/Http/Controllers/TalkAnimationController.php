...
use App\Http\Requests\TalkAnimationStoreRequest;
...
class TalkAnimationController extends Controller
{
     ...
     */
    public function store(TalkAnimationStoreRequest $request)
    {
        try {
     ...
     */
    public function update(TalkAnimationUpdateRequest $request, Category $category)
    {
        try {
